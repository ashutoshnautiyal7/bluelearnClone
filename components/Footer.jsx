...
const Footer = () => (
  <motion.footer
    ...
    className={`  relative`}
  >
    <footer className="text-center lg:px-24  lg:text-left bg-[#121212] text-white">
    ...
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="">
        <h6 className="
          ...
          <span className='flex text-4xl'><h1 className='text-blue-600 '>blue</h1>learn </span>
        </h6>
        <p>
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-white">Hall of fame</a>
        </p>
  ...
  <div className="text-start p-6  border-white">
    ...
    <a className="text-white font-semibold" href="https://tailwind-elements.com/"> Clinify Pvt. Ltd. All Rights Reserved.</a>
  </div>
</footer>
